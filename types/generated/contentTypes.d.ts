...
export interface ApiEpisodeEpisode extends Schema.CollectionType {
  ...
  attributes: {
    ...
    podcast: Attribute.Relation<
      ...
      'api::podcast.podcast'
    >;
    banner: Attribute.String & Attribute.Required;
...
export interface ApiLinkLink extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    post: Attribute.Relation<'api::link.link', 'manyToOne', 'api::post.post'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    adminApproval: Attribute.Boolean & Attribute.DefaultTo<true>;
    name: Attribute.String & Attribute.Unique;
    views: Attribute.BigInteger & Attribute.DefaultTo<'0'>;
    readingTime: Attribute.BigInteger & Attribute.DefaultTo<'0'>;
    comments: Attribute.BigInteger & Attribute.DefaultTo<'0'>;
    likes: Attribute.BigInteger & Attribute.DefaultTo<'0'>;
    commentsList: Attribute.Relation<
      'api::post.post',
      'oneToMany',
      'api::comment.comment'
    >;
    ...
    opinions: Attribute.Relation<
      ...
      'api::opinion.opinion'
    >;
    links: Attribute.Relation<'api::post.post', 'oneToMany', 'api::link.link'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiSubscriptionSubscription extends Schema.CollectionType {
  ...
  attributes: {
    email: Attribute.Email & Attribute.Private & Attribute.Unique;
    ...
    unsubscribeToken: Attribute.String & Attribute.Private & Attribute.Unique;
    lastSubscriptionTime: Attribute.DateTime &
      Attribute.Required &
      Attribute.Private;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
